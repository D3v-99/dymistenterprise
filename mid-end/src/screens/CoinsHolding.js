...
const CoinsHolding = () => {
  ...
  return (
    ...
    >
      <h3 className="text-center mb-4">Coins  Form</h3>
            ...
            <Col xs="3">
              <div className="form-floating">
                ...
                >
                  ...
                  <option value="50_cents"> 50 cents</option>
                  <option value="1">1 Shilling</option>
                  <option value="5">5 Shillings</option>
                 <option value="10">10 Shillings</option>
                  <option value="20">20 Shillings</option>
                  <option value="40">40 Shillings</option>
